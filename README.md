...
Exemplo de autenticação com Google Firebase em Next 13.
...
- 1.2 - No menu lateral esquerdo, seleciona a opção Segurança -> **Authentication**. Clique no botão Get Started (Começar)

2 - Criar o usuário direto no Firebase
- 2.1 - Clique no seu projeto e vá em Segurança -> **Authentication** no menu lateral esquerdo.
